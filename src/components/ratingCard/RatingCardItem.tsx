...
const RatingCardItem: React.FC<RatingCardItemProps> = ({
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg p-6 w-[400px] h-auto flex flex-col m-5 transition-transform transform hover:scale-105 duration-300">
      {/* Image Section */}
      ...
      {/* Description */}
      <p className="text-customGrayLight2 text-md h-24 whitespace-normal overflow-visible">
        {description}
      </p>
    </div>
  );
